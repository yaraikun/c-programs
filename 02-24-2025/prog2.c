...
void InputStudentData(int ID[], Str15 FIRSTNAME[], Str15 LASTNAME[],
                      float GRADE[])
{
    int i;
    int id_number;
...
void PrintStudentData(int ID[], Str15 FIRSTNAME[], Str15 LASTNAME[],
                      float GRADE[])
{
    int i;
...
int main()
{
    ...
    InputStudentData(ID, FIRSTNAME, LASTNAME, GRADE);
